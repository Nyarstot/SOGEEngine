#ifndef SOGE_INPUT_DEVICE_HPP
#define SOGE_INPUT_DEVICE_HPP
...
namespace soge
{
    ...
    public:
        ...
        void AddPressedKey(KeyboardKeys aKey);
        void RemovePressedKey(KeyboardKeys aKey);
        void IsKeyPressed(KeyboardKeys aKey);

    };
}

#endif // !SOGE_INPUT_DEVICE_HPP
