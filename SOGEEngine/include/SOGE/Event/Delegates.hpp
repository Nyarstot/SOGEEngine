#ifndef SOGE_DELEGATES_HPP
#define SOGE_DELEGATES_HPP
...
namespace soge
{
    ...
    #endif // !DELEGATE_INLINE_ALLOCATION_SIZE
    ...
    #define DECLARE_MULTICAST_DELEGATE(name, ...) { using name = MulticastDelegate<__VA_ARGS__>; using name ## Delegate = MulticastDelegate<__VA_ARGS__>::DelegateT }
    ...
    public:
        ...
        constexpr InlineAllocator() noexcept
            : m_Size(0)
        {
            SOGE_DELEGATE_STATIC_ASSERT(MaxStackSize > sizeof(void*), 
